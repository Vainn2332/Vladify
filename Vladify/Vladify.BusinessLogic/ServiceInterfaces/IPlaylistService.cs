...
public interface IPlaylistService
{
    ...
    public Task<PlaylistModel> AddSongToPlaylistAsync(Guid playlistId, Guid songId, CancellationToken cancellationToken);
    ...
    public Task<PlaylistModel> DeleteSongFromPlaylistAsync(Guid playlistId, Guid songId, CancellationToken cancellationToken);
