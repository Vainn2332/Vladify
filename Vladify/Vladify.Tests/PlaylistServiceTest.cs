...
public class PlaylistServiceTest
{
    ...
    public async Task AddPlaylistAsync_Should_ReturnPlaylistModel_WhenOk()
    {
        ...
        _playlistRepositoryMock.Setup(m => m.AddAsync(playlistEntity, It.IsAny<CancellationToken>()))
            .ReturnsAsync(playlistEntity);
        _playlistRepositoryMock.Setup(m => m.GetPlaylistAsync(playlistEntity.Id, false, It.IsAny<CancellationToken>()))
        ...
        _playlistRepositoryMock.Verify(m => m.AddAsync(playlistEntity, It.IsAny<CancellationToken>()), Times.Once);
        _playlistRepositoryMock.Verify(m => m.GetPlaylistAsync(playlistEntity.Id, false, It.IsAny<CancellationToken>()), Times.Once);
    }
