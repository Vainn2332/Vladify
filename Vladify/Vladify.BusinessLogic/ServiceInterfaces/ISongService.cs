...
public interface ISongService
{
    ...
    public Task<PagedResponse<SongModel>> GetSongsAsync(PaginationFilter filter, CancellationToken cancellationToken);
    public Task<SongModel> AddSongAsync(SongAddDto songAddDto, CancellationToken cancellationToken);
